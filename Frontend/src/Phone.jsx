  ...
  return (
    <div className="phone">
      ...
      <div className="pcontainer">
        {filtersearch.length>0 ? filtersearch.map((p) => (
          <div className="phone-container" key={p.pid}>
            ...
            <div className="phone-price-offers">
              ...
              <p className="assured"><b>Assured</b></p>
              </div>
              <div className="price-offer">
                <p className="original-price">₹{p.price} 
              </p>
              <p className="discount-percent">{p.discount}% OFF</p>
               ...
               <div className="discountUpto">
                ...
                <p className="totaldis">Upto <b>{(p.price*(totalDiscount) / 100).toFixed()}</b> off on Exchange</p>
               </div>
             
            </div>
          </div>
        )): <h2 className="noresult" style={{ textAlign : "Center" }}>No products found</h2>}  
      </div>
      <Footer></Footer>
    </div>
  );
